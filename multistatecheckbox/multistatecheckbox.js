...
this.primereact_test.multistatecheckbox = (function (exports, React, core) {
  'use strict';
  ...
  var MultiStateCheckbox = /*#__PURE__*/function (_Component) {
    ...
    _createClass(MultiStateCheckbox, [{
      ...
      value: function findSelectedOptionMap() {
        ...
        if (this.props.options) {
          ...
          index = this.props.options.findIndex(function (option) {
            return core.ObjectUtils.equals(_this2.props.value, _this2.getOptionValue(option), key);
          });
      ...
      value: function renderIcon(option) {
        ...
        var className = core.classNames('p-checkbox-icon p-c', _defineProperty({}, "".concat(icon), true));
        ...
        if (this.props.iconTemplate) {
          ...
          return core.ObjectUtils.getJSXElement(this.props.iconTemplate, defaultOptions);
        }
      ...
      value: function render() {
        ...
        var containerClassName = core.classNames('p-multistatecheckbox p-checkbox p-component', this.props.className);
        var boxClassName = core.classNames('p-checkbox-box', {
          'p-highlight': !!option,
