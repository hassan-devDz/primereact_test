...
this.primereact_test.tree = (function (exports, React, core) {
  'use strict';
  ...
  var UITreeNode = /*#__PURE__*/function (_Component) {
    ...
    _createClass(UITreeNode, [{
      ...
      value: function onNodeKeyDown(event) {
        ...
        if (!core.DomHandler.hasClass(nodeElement, 'p-treenode')) {
          return;
        }
      ...
      value: function getParentNodeElement(nodeElement) {
        ...
        return core.DomHandler.hasClass(parentNodeElement, 'p-treenode') ? parentNodeElement : null;
      }
    }, {
      key: "focusNode",
      ...
      value: function onDropPoint(event, position) {
        ...
        if (this.props.node.droppable !== false) {
          core.DomHandler.removeClass(event.target, 'p-treenode-droppoint-active');
      ...
      value: function onDropPointDragEnter(event) {
        if (event.dataTransfer.types[1] === this.props.dragdropScope.toLocaleLowerCase()) {
          core.DomHandler.addClass(event.target, 'p-treenode-droppoint-active');
        }
      }
    }, {
      ...
      value: function onDrop(event) {
        if (this.props.dragdropScope && this.props.node.droppable !== false) {
          core.DomHandler.removeClass(this.contentElement, 'p-treenode-dragover');
          event.preventDefault();
      ...
      value: function onDragEnter(event) {
        if (event.dataTransfer.types[1] === this.props.dragdropScope.toLocaleLowerCase() && this.props.node.droppable !== false) {
          core.DomHandler.addClass(this.contentElement, 'p-treenode-dragover');
        }
      }
    }, {
      key: "onDragLeave",
      ...
      value: function renderLabel() {
        ...
        if (this.props.nodeTemplate) {
          ...
          content = core.ObjectUtils.getJSXElement(this.props.nodeTemplate, this.props.node, defaultContentOptions);
        }
      ...
      value: function renderIcon(expanded) {
        ...
        if (icon) {
          var className = core.classNames('p-treenode-icon', icon);
      ...
      value: function renderToggler(expanded) {
        var iconClassName = core.classNames('p-tree-toggler-icon pi pi-fw', {
        ...
        if (this.props.togglerTemplate) {
          ...
          content = core.ObjectUtils.getJSXElement(this.props.togglerTemplate, this.props.node, defaultContentOptions);
        }
      ...
      value: function renderContent() {
        ...
        var selected = this.isSelected();
        var checked = this.isChecked();
        var className = core.classNames('p-treenode-content', this.props.node.className, {
      ...
      value: function renderNode() {
        var className = core.classNames('p-treenode', {
  ...
  var Tree = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Tree, [{
      ...
      value: function filter(value) {
        this.setState({
          filterValue: core.ObjectUtils.isNotEmpty(value) ? value : ''
        }, this._filter);
      }
    }, {
      key: "_filter",
      value: function _filter() {
        ...
        if (core.ObjectUtils.isEmpty(filterValue)) {
      ...
      value: function isFilterMatched(node, _ref) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            var fieldValue = String(core.ObjectUtils.resolveFieldData(node, field)).toLocaleLowerCase(this.props.filterLocale);
      ...
      value: function renderModel() {
        if (this.props.value) {
          ...
          var contentClass = core.classNames('p-tree-container', this.props.contentClassName);
          return /*#__PURE__*/React__default['default'].createElement("ul", {
      ...
      value: function renderLoader() {
        if (this.props.loading) {
          var icon = core.classNames('p-tree-loading-icon pi-spin', this.props.loadingIcon);
          return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      value: function renderHeader() {
        if (this.props.showHeader) {
          ...
          if (this.props.header) {
            ...
            content = core.ObjectUtils.getJSXElement(this.props.header, defaultContentOptions);
          }
      ...
      value: function renderFooter() {
        var content = core.ObjectUtils.getJSXElement(this.props.footer, this.props);
        return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      key: "render",
      value: function render() {
        var className = core.classNames('p-tree p-component', this.props.className, {
