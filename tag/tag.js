...
this.primereact_test.tag = (function (exports, React, core) {
  'use strict';
  ...
  var Tag = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Tag, [{
      ...
      value: function render() {
        var tagClassName = core.classNames('p-tag p-component', {
        ...
        var iconClass = core.classNames('p-tag-icon', this.props.icon);
        return /*#__PURE__*/React__default['default'].createElement("span", {
          className: tagClassName,
          style: this.props.style
        }, this.props.icon && /*#__PURE__*/React__default['default'].createElement("span", {
          className: iconClass
