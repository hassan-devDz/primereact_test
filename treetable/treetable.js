...
this.primereact_test.treetable = (function (exports, React, core, paginator, inputtext) {
  'use strict';
      ...
      value: function renderHeaderCell(column, options) {
        ...
        if (options.filterOnly) {
          return /*#__PURE__*/React__default['default'].createElement("th", {
            ...
            className: core.classNames('p-filter-column', column.props.filterHeaderClassName),
          ...
          var className = core.classNames(column.props.headerClassName || column.props.className, {
  ...
  var TreeTableBodyCell = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeTableBodyCell, [{
      ...
      value: function componentDidUpdate() {
        ...
        if (this.container && this.props.editor) {
          ...
          if (this.state && this.state.editing) {
            var focusable = core.DomHandler.findSingle(this.container, 'input');
      ...
      value: function render() {
        ...
        var className = core.classNames(this.props.bodyClassName || this.props.className, {
        ...
        if (this.state && this.state.editing) {
          ...
          if (this.props.body) content = this.props.body(this.props.node, this.props);else content = core.ObjectUtils.resolveFieldData(this.props.node.data, this.props.field);
        }
        /* eslint-disable */
  ...
  var TreeTableRow = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeTableRow, [{
      ...
      value: function onCheckboxFocus() {
        core.DomHandler.addClass(this.checkboxBox, 'p-focus');
      }
    }, {
      key: "onCheckboxBlur",
      value: function onCheckboxBlur() {
        core.DomHandler.removeClass(this.checkboxBox, 'p-focus');
      }
    }, {
      key: "propagateUp",
      ...
      value: function renderToggler() {
        ...
        var iconClassName = core.classNames('"p-treetable-toggler-icon pi pi-fw', {
      ...
      value: function renderCheckbox() {
        ...
        if (this.props.selectionMode === 'checkbox' && this.props.node.selectable !== false) {
          ...
          var className = core.classNames('p-checkbox-box', {
            'p-highlight': checked,
            'p-indeterminate': partialChecked
          });
          var icon = core.classNames('p-checkbox-icon p-c', {
            'pi pi-check': checked,
      ...
      value: function render() {
        ...
        className = core.classNames(className, this.props.node.className);
    ...
    _createClass(TreeTableScrollableView, [{
      ...
      value: function findDataTableContainer(element) {
        if (element) {
          ...
          while (el && !core.DomHandler.hasClass(el, 'p-treetable')) {
            el = el.parentElement;
          }
      ...
      value: function onBodyScroll() {
        ...
        if (frozenView) {
          frozenScrollBody = core.DomHandler.findSingle(frozenView, '.p-treetable-scrollable-body');
        }
      ...
      value: function calculateRowHeight() {
        var row = core.DomHandler.findSingle(this.scrollTable, 'tr:not(.p-treetable-emptymessage-row)');

        if (row) {
          this.rowHeight = core.DomHandler.getOuterHeight(row);
        }
      }
    }, {
      key: "renderColGroup",
      ...
      value: function render() {
        ...
        var className = core.classNames('p-treetable-scrollable-view', {
  ...
  var TreeTable = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeTable, [{
      ...
      value: function sortNodes(data) {
        ...
        if (this.columnSortable && this.columnSortable === 'custom' && this.columnSortFunction) {
          ...
          value.sort(function (node1, node2) {
            ...
            var value1 = core.ObjectUtils.resolveFieldData(node1.data, sortField);
            var value2 = core.ObjectUtils.resolveFieldData(node2.data, sortField);
            var result = null;
      ...
      value: function multisortField(node1, node2, multiSortMeta, index) {
        var value1 = core.ObjectUtils.resolveFieldData(node1.data, multiSortMeta[index].field);
        var value2 = core.ObjectUtils.resolveFieldData(node2.data, multiSortMeta[index].field);
        var result = null;
          ...
          if (this.props.columnResizeMode === 'fit') {
            ...
            if (newColumnWidth > 15 && nextColumnWidth > 15) {
              if (this.props.scrollable) {
                ...
                var scrollableBodyTable = core.DomHandler.findSingle(scrollableView, 'table.p-treetable-scrollable-body-table');
                var scrollableHeaderTable = core.DomHandler.findSingle(scrollableView, 'table.p-treetable-scrollable-header-table');
                var scrollableFooterTable = core.DomHandler.findSingle(scrollableView, 'table.p-treetable-scrollable-footer-table');
            ...
            if (this.props.scrollable) {
              ...
              var _scrollableBodyTable = core.DomHandler.findSingle(_scrollableView, 'table.p-treetable-scrollable-body-table');

              var _scrollableHeaderTable = core.DomHandler.findSingle(_scrollableView, 'table.p-treetable-scrollable-header-table');

              var _scrollableFooterTable = core.DomHandler.findSingle(_scrollableView, 'table.p-treetable-scrollable-footer-table');
              ...
              var _resizeColumnIndex = core.DomHandler.index(this.resizeColumn);
      ...
      value: function findParentScrollableView(column) {
        if (column) {
          ...
          while (parent && !core.DomHandler.hasClass(parent, 'p-treetable-scrollable-view')) {
        ...
        if (this.draggedColumnEl) {
          ...
          if (allowDrop) {
            ...
            var isSameColumn = function isSameColumn(col1, col2) {
              return col1.props.columnKey || col2.props.columnKey ? core.ObjectUtils.equals(col1, col2, 'props.columnKey') : core.ObjectUtils.equals(col1, col2, 'props.field');
            };
          ...
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            for (var j = 0; j < columns.length; j++) {
              ...
              if (filterMeta) {
                ...
                filterConstraint = filterMatchMode === 'custom' ? col.props.filterFunction : core.FilterUtils[filterMatchMode];
                options = {
                  rowData: node,
                  filters: filters,
                  props: this.props,
              ...
              if (this.props.globalFilter && !globalMatch) {
                ...
                filterConstraint = core.FilterUtils['contains'];
                paramsWithoutNode = {
                  filterField: filterField,
                  filterValue: filterValue,
                  filterConstraint: filterConstraint,
      ...
      value: function isFilterMatched(node, _ref) {
        ...
        var matched = false;
        var dataFieldValue = core.ObjectUtils.resolveFieldData(node.data, filterField);
      ...
      value: function renderLoader() {
        if (this.props.loading) {
          var iconClassName = core.classNames('p-treetable-loading-icon pi-spin', this.props.loadingIcon);
          return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      value: function render() {
        ...
        var className = core.classNames('p-treetable p-component', {
...
}({}, React, primereact_test.core, primereact_test.paginator, primereact_test.inputtext));
