...
this.primereact_test.panel = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(Panel, [{
      ...
      value: function renderHeader(collapsed) {
        ...
        if (this.props.headerTemplate) {
          ...
          return core.ObjectUtils.getJSXElement(this.props.headerTemplate, defaultContentOptions);
      ...
      value: function render() {
        var className = core.classNames('p-panel p-component', {
