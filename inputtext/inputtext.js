...
this.primereact_test.inputtext = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(InputTextComponent, [{
      ...
      value: function onKeyPress(event) {
        ...
        if (this.props.keyfilter) {
          core.KeyFilter.onKeyPress(event, this.props.keyfilter, this.props.validateOnly);
        }
      }
    }, {
      key: "onInput",
      value: function onInput(event) {
        ...
        if (this.props.keyfilter && this.props.validateOnly) {
          validatePattern = core.KeyFilter.validate(event, this.props.keyfilter);
        }
        ...
        if (!this.props.onChange) {
          if (event.target.value.length > 0) core.DomHandler.addClass(event.target, 'p-filled');else core.DomHandler.removeClass(event.target, 'p-filled');
        }
      }
    }, {
      ...
      value: function render() {
        var className = core.classNames('p-inputtext p-component', {
          'p-disabled': this.props.disabled,
          'p-filled': this.isFilled()
        }, this.props.className);
        var inputProps = core.ObjectUtils.findDiffKeys(this.props, InputTextComponent.defaultProps);
