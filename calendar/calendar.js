...
this.primereact_test.calendar = (function (exports, React, inputtext, button, core, PrimeReact) {
  'use strict';
    ...
    _createClass(Calendar, [{
      ...
      value: function componentDidMount() {
        ...
        if (this.props.inline) {
          ...
          core.mask(this.inputRef.current, {
      ...
      value: function getDateFormat() {
        return this.props.dateFormat || PrimeReact.localeOption('dateFormat', this.props.locale);
      }
    }, {
      key: "onInputFocus",
      ...
      value: function trapFocus(event) {
        event.preventDefault();
        var focusableElements = core.DomHandler.getFocusableElements(this.overlayRef.current);
      ...
      value: function updateFocus() {
        ...
        if (this.navigation) {
          if (this.navigation.button) {
            this.initFocusableCell();
            if (this.navigation.backward) core.DomHandler.findSingle(this.overlayRef.current, '.p-datepicker-prev').focus();else core.DomHandler.findSingle(this.overlayRef.current, '.p-datepicker-next').focus();
          } else {
            if (this.navigation.backward) {
              var cells = core.DomHandler.find(this.overlayRef.current, '.p-datepicker-calendar td span:not(.p-disabled)');
              cell = cells[cells.length - 1];
            } else {
              cell = core.DomHandler.findSingle(this.overlayRef.current, '.p-datepicker-calendar td span:not(.p-disabled)');
            }
      ...
      value: function initFocusableCell() {
        ...
        if (this.view === 'month') {
          var cells = core.DomHandler.find(this.overlayRef.current, '.p-monthpicker .p-monthpicker-month');
          var selectedCell = core.DomHandler.findSingle(this.overlayRef.current, '.p-monthpicker .p-monthpicker-month.p-highlight');
          cells.forEach(function (cell) {
            return cell.tabIndex = -1;
          });
          cell = selectedCell || cells[0];
        } else {
          cell = core.DomHandler.findSingle(this.overlayRef.current, 'span.p-highlight');

          if (!cell) {
            var todayCell = core.DomHandler.findSingle(this.overlayRef.current, 'td.p-datepicker-today span:not(.p-disabled)');
            if (todayCell) cell = todayCell;else cell = core.DomHandler.findSingle(this.overlayRef.current, '.p-datepicker-calendar td span:not(.p-disabled)');
          }
        }
          ...
          case 40:
            {
              ...
              if (nextRow) {
                ...
                if (core.DomHandler.hasClass(focusCell, 'p-disabled')) {
                  this.navigation = {
                    backward: false
                  };
                  this.navForward(event);
          ...
          case 38:
            {
              ...
              var _cellIndex = core.DomHandler.index(cell);
              ...
              if (prevRow) {
                ...
                if (core.DomHandler.hasClass(_focusCell, 'p-disabled')) {
                  this.navigation = {
                    backward: true
                  };
                  this.navBackward(event);
          ...
          case 37:
            {
              ...
              if (prevCell) {
                ...
                if (core.DomHandler.hasClass(_focusCell2, 'p-disabled')) {
          ...
          case 39:
            {
              ...
              if (nextCell) {
                ...
                if (core.DomHandler.hasClass(_focusCell3, 'p-disabled')) {
      ...
      value: function showOverlay(type) {
        ...
        if (this.props.onVisibleChange) {
          ...
          this.setState({
            ...
            core.OverlayService.on('overlay-click', _this10.overlayEventListener);
          });
        }
      }
    }, {
      ...
      value: function hideOverlay(type, callback) {
        ...
        var _hideCallback = function _hideCallback() {
          ...
          core.OverlayService.off('overlay-click', _this11.overlayEventListener);
      ...
      value: function onOverlayEnter() {
        if (this.props.autoZIndex) {
          core.ZIndexUtils.set(this.props.touchUI ? 'modal' : 'overlay', this.overlayRef.current, this.props.baseZIndex);
        }
      ...
      value: function isNavIconClicked(target) {
        return core.DomHandler.hasClass(target, 'p-datepicker-prev') || core.DomHandler.hasClass(target, 'p-datepicker-prev-icon') || core.DomHandler.hasClass(target, 'p-datepicker-next') || core.DomHandler.hasClass(target, 'p-datepicker-next-icon');
      }
    }, {
      key: "onWindowResize",
      value: function onWindowResize() {
        if (this.isVisible() && !core.DomHandler.isAndroid()) {
          this.hideOverlay();
        }
      }
    }, {
      ...
      value: function enableModality() {
        ...
        if (!this.touchUIMask) {
          ...
          this.touchUIMask.style.zIndex = String(core.ZIndexUtils.get(this.overlayRef.current) - 1);
          core.DomHandler.addMultipleClasses(this.touchUIMask, 'p-component-overlay p-datepicker-mask p-datepicker-mask-scrollblocker');
      ...
      value: function disableModality() {
        if (this.touchUIMask) {
          ...
          for (var i = 0; i < bodyChildren.length; i++) {
            ...
            if (core.DomHandler.hasClass(bodyChild, 'p-datepicker-mask-scrollblocker')) {
      ...
      value: function getSundayIndex() {
        var firstDayOfWeek = PrimeReact.localeOption('firstDayOfWeek', this.props.locale);
      ...
      value: function createWeekDays() {
        ...
        var _localeOptions = PrimeReact.localeOptions(this.props.locale),
      ...
      value: function formatDate(date, format) {
        ...
        var _localeOptions2 = PrimeReact.localeOptions(this.props.locale),
      ...
      value: function parseDate(value, format) {
        ...
        var _localeOptions3 = PrimeReact.localeOptions(this.props.locale),
      ...
      value: function renderTitleMonthElement(month) {
        ...
        var monthNames = PrimeReact.localeOption('monthNames', this.props.locale);
        ...
        if (this.props.monthNavigator && this.props.view !== 'month') {
          ...
          if (this.props.monthNavigatorTemplate) {
            ...
            return core.ObjectUtils.getJSXElement(this.props.monthNavigatorTemplate, defaultContentOptions);
          }
      ...
      value: function renderTitleYearElement(year) {
        ...
        if (this.props.yearNavigator) {
          ...
          if (this.props.yearNavigatorTemplate) {
            ...
            return core.ObjectUtils.getJSXElement(this.props.yearNavigatorTemplate, defaultContentOptions);
          }
      ...
      value: function renderHourPicker() {
        ...
        }), /*#__PURE__*/React__default['default'].createElement(core.Ripple, null)), /*#__PURE__*/React__default['default'].createElement("span", null, hourDisplay), /*#__PURE__*/React__default['default'].createElement("button", {
          type: "button",
          className: "p-link",
          onMouseDown: function onMouseDown(e) {
            return _this24.onTimePickerElementMouseDown(e, 0, -1);
      ...
      value: function renderMinutePicker() {
        ...
        return /*#__PURE__*/React__default['default'].createElement("div", {
          ...
          className: "pi pi-chevron-up"
        }), /*#__PURE__*/React__default['default'].createElement(core.Ripple, null)), /*#__PURE__*/React__default['default'].createElement("span", null, minuteDisplay), /*#__PURE__*/React__default['default'].createElement("button", {
          type: "button",
          className: "p-link",
          onMouseDown: function onMouseDown(e) {
            return _this25.onTimePickerElementMouseDown(e, 1, -1);
      ...
      value: function renderSecondPicker() {
        ...
        if (this.props.showSeconds) {
          ...
          return /*#__PURE__*/React__default['default'].createElement("div", {
            ...
            className: "pi pi-chevron-up"
          }), /*#__PURE__*/React__default['default'].createElement(core.Ripple, null)), /*#__PURE__*/React__default['default'].createElement("span", null, secondDisplay), /*#__PURE__*/React__default['default'].createElement("button", {
            type: "button",
            className: "p-link",
            onMouseDown: function onMouseDown(e) {
              return _this26.onTimePickerElementMouseDown(e, 2, -1);
      ...
      value: function renderMiliSecondPicker() {
        ...
        if (this.props.showMillisec) {
          ...
          return /*#__PURE__*/React__default['default'].createElement("div", {
            ...
            className: "pi pi-chevron-up"
          }), /*#__PURE__*/React__default['default'].createElement(core.Ripple, null)), /*#__PURE__*/React__default['default'].createElement("span", null, millisecondDisplay), /*#__PURE__*/React__default['default'].createElement("button", {
            type: "button",
            className: "p-link",
            onMouseDown: function onMouseDown(e) {
              return _this27.onTimePickerElementMouseDown(e, 3, -1);
      ...
      value: function renderAmPmPicker() {
        if (this.props.hourFormat === '12') {
          ...
          return /*#__PURE__*/React__default['default'].createElement("div", {
            ...
            className: "pi pi-chevron-up"
          }), /*#__PURE__*/React__default['default'].createElement(core.Ripple, null)), /*#__PURE__*/React__default['default'].createElement("span", null, display), /*#__PURE__*/React__default['default'].createElement("button", {
            type: "button",
            className: "p-link",
            onClick: this.toggleAmPm
          }, /*#__PURE__*/React__default['default'].createElement("span", {
      ...
      value: function renderButtonBar() {
        ...
        if (this.props.showButtonBar) {
          var todayClassName = core.classNames('p-button-text', this.props.todayButtonClassName);
          var clearClassName = core.classNames('p-button-text', this.props.clearButtonClassName);
      ...
      value: function render() {
        ...
        var className = core.classNames('p-calendar p-component p-inputwrapper', this.props.className, {
...
}({}, React, primereact_test.inputtext, primereact_test.button, primereact_test.core, primereact_test.api));
