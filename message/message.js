...
this.primereact_test.message = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(Message, [{
      ...
      value: function getContent() {
        if (this.props.content) {
          return core.ObjectUtils.getJSXElement(this.props.content, this.props);
        }

        var icon = core.classNames('p-inline-message-icon pi', {
      ...
      value: function render() {
        var className = core.classNames('p-inline-message p-component', {
