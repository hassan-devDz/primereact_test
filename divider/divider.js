...
this.primereact_test.divider = (function (exports, React, core) {
  'use strict';
  ...
  var Divider = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Divider, [{
      ...
      value: function render() {
        var dividerClassName = core.classNames("p-divider p-component p-divider-".concat(this.props.layout, " p-divider-").concat(this.props.type), {
