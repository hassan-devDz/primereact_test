...
this.primereact_test.chip = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(Chip, [{
      ...
      value: function renderContent() {
        ...
        if (this.props.image) {
          ...
          var iconClassName = core.classNames('p-chip-icon', this.props.icon);
        ...
        if (this.props.removable) {
          var removableIconClassName = core.classNames('p-chip-remove-icon', this.props.removeIcon);
          content.push( /*#__PURE__*/React__default['default'].createElement("span", {
            key: "removeIcon",
            tabIndex: 0,
      ...
      value: function renderElement() {
        var containerClassName = core.classNames('p-chip p-component', {
