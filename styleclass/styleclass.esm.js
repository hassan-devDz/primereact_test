...
import { DomHandler } from 'primereact_test/core';
      ...
      if (this.props.enterActiveClassName) {
        if (!this.animating) {
          ...
          this.enterListener = function () {
            DomHandler.removeClass(_this.target, _this.props.enterActiveClassName);

            if (_this.props.enterToClassName) {
              DomHandler.addClass(_this.target, _this.props.enterToClassName);
            }
      ...
      if (this.props.leaveActiveClassName) {
        if (!this.animating) {
          ...
          this.leaveListener = function () {
            DomHandler.removeClass(_this2.target, _this2.props.leaveActiveClassName);

            if (_this2.props.leaveToClassName) {
              DomHandler.addClass(_this2.target, _this2.props.leaveToClassName);
            }
    ...
    value: function bindEvents() {
      ...
      this.clickListener = function () {
        ...
        if (_this4.props.toggleClassName) {
          if (DomHandler.hasClass(_this4.target, _this4.props.toggleClassName)) DomHandler.removeClass(_this4.target, _this4.props.toggleClassName);else DomHandler.addClass(_this4.target, _this4.props.toggleClassName);
        } else {
