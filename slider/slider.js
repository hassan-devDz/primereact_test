...
this.primereact_test.slider = (function (exports, React, core) {
  'use strict';
  ...
  var Slider = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Slider, [{
      ...
      value: function updateDomData() {
        ...
        this.initX = rect.left + core.DomHandler.getWindowScrollLeft();
        this.initY = rect.top + core.DomHandler.getWindowScrollTop();
      ...
      value: function renderHandle(leftValue, bottomValue, index) {
        ...
        var handleClassName = core.classNames('p-slider-handle', {
      ...
      value: function render() {
        ...
        var className = core.classNames('p-slider p-component', this.props.className, {
