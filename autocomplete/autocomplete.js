...
this.primereact_test.autocomplete = (function (exports, React, inputtext, button, core, virtualscroller, PrimeReact) {
  'use strict';
    ...
    _createClass(AutoCompletePanelComponent, [{
      ...
      value: function renderGroupChildren(optionGroup, i) {
        ...
        return groupChildren.map(function (item, j) {
          var itemContent = _this.props.itemTemplate ? core.ObjectUtils.getJSXElement(_this.props.itemTemplate, item, j) : _this.props.field ? core.ObjectUtils.resolveFieldData(item, _this.props.field) : item;
          return /*#__PURE__*/React__default['default'].createElement("li", {
            ...
            "data-group": i,
            "data-index": j
          }, itemContent, /*#__PURE__*/React__default['default'].createElement(core.Ripple, null));
        });
      }
    }, {
      key: "renderItem",
      value: function renderItem(suggestion, index) {
        ...
        if (this.props.optionGroupLabel) {
          var groupContent = this.props.optionGroupTemplate ? core.ObjectUtils.getJSXElement(this.props.optionGroupTemplate, suggestion, index) : this.props.getOptionGroupLabel(suggestion);
          ...
          var itemContent = this.props.itemTemplate ? core.ObjectUtils.getJSXElement(this.props.itemTemplate, suggestion, index) : this.props.field ? core.ObjectUtils.resolveFieldData(suggestion, this.props.field) : suggestion;
          return /*#__PURE__*/React__default['default'].createElement("li", {
            key: index + '_item',
            role: "option",
        ...
        if (this.props.virtualScrollerOptions) {
          var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, this.props.virtualScrollerOptions), {
            ...
            contentTemplate: function contentTemplate(options) {
              var className = core.classNames('p-autocomplete-items', options.className);
      ...
      value: function renderElement() {
        var panelClassName = core.classNames('p-autocomplete-panel p-component', this.props.panelClassName);
    ...
    _createClass(AutoComplete, [{
      ...
      value: function formatValue(value) {
        if (value) {
          if (this.props.selectedItemTemplate && (this.props.multiple ? this.isSelected(value) : this.findOptionIndex(value) > -1)) {
            var resolvedFieldData = core.ObjectUtils.getJSXElement(this.props.selectedItemTemplate, value);
            return resolvedFieldData ? resolvedFieldData : value;
          } else if (this.props.field) {
            var _resolvedFieldData = core.ObjectUtils.resolveFieldData(value, this.props.field);
      ...
      value: function onOverlayEntering() {
        if (this.props.autoHighlight && this.props.suggestions && this.props.suggestions.length) {
          core.DomHandler.addClass(this.overlayRef.current.firstChild.firstChild, 'p-highlight');
        }
      }
    }, {
      ...
      value: function alignOverlay() {
        ...
        core.DomHandler.alignOverlay(this.overlayRef.current, target, this.props.appendTo || PrimeReact__default['default'].appendTo);
      }
    }, {
      key: "onPanelClick",
          ...
          switch (event.which) {
            ...
            case 40:
              if (highlightItem) {
                ...
                if (core.DomHandler.hasClass(highlightItem, 'p-autocomplete-item-group')) {
      ...
      value: function selectHighlightItem(event, item) {
        if (this.props.optionGroupLabel) {
          ...
          this.selectItem(event, this.props.suggestions[core.DomHandler.index(item)]);
        }
      }
    }, {
      key: "findNextItem",
      value: function findNextItem(item) {
        ...
        return nextItem ? core.DomHandler.hasClass(nextItem, 'p-autocomplete-item-group') ? this.findNextItem(nextItem) : nextItem : null;
      }
    }, {
      key: "findPrevItem",
      value: function findPrevItem(item) {
        var prevItem = item.previousElementSibling;
        return prevItem ? core.DomHandler.hasClass(prevItem, 'p-autocomplete-item-group') ? this.findPrevItem(prevItem) : prevItem : null;
      }
    }, {
      key: "onInputFocus",
        ...
        if (this.props.suggestions) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var itemValue = this.props.field ? core.ObjectUtils.resolveFieldData(item, this.props.field) : item;
      ...
      value: function onMultiInputFocus(event) {
        ...
        core.DomHandler.addClass(this.multiContainer, 'p-focus');
      }
    }, {
      key: "onMultiInputBlur",
      value: function onMultiInputBlur(event) {
        this.onInputBlur(event);
        core.DomHandler.removeClass(this.multiContainer, 'p-focus');
      }
    }, {
      key: "isSelected",
      value: function isSelected(val) {
        ...
        if (this.props.value && this.props.value.length) {
          for (var i = 0; i < this.props.value.length; i++) {
            if (core.ObjectUtils.equals(this.props.value[i], val)) {
              selected = true;
              break;
            }
          }
      ...
      value: function findOptionIndex(option) {
        ...
        if (this.props.suggestions) {
          for (var i = 0; i < this.props.suggestions.length; i++) {
            if (core.ObjectUtils.equals(option, this.props.suggestions[i])) {
              index = i;
              break;
            }
          }
      ...
      value: function getOptionGroupLabel(optionGroup) {
        return this.props.optionGroupLabel ? core.ObjectUtils.resolveFieldData(optionGroup, this.props.optionGroupLabel) : optionGroup;
      }
    }, {
      ...
      value: function bindResizeListener() {
        ...
        if (!this.resizeListener) {
          this.resizeListener = function () {
            if (_this7.state.overlayVisible && !core.DomHandler.isAndroid()) {
              _this7.hideOverlay();
            }
          };
      ...
      value: function renderSimpleAutoComplete() {
        var inputClassName = core.classNames('p-autocomplete-input', this.props.inputClassName, {
      ...
      value: function renderMultipleAutoComplete() {
        ...
        var multiContainerClass = core.classNames('p-autocomplete-multiple-container p-component p-inputtext', {
      ...
      value: function render() {
        ...
        var input, dropdown;
        var className = core.classNames('p-autocomplete p-component p-inputwrapper', this.props.className, {
...
}({}, React, primereact_test.inputtext, primereact_test.button, primereact_test.core, primereact_test.virtualscroller, primereact_test.api));
