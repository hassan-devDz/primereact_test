...
this.primereact_test.fullcalendar = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(FullCalendar, [{
      ...
      value: function componentDidUpdate(prevProps) {
        if (!this.calendar) {
          ...
          if (!core.ObjectUtils.equals(prevProps.events, this.props.events)) {
            this.calendar.removeAllEventSources();
            this.calendar.addEventSource(this.props.events);
          }

          if (!core.ObjectUtils.equals(prevProps.options, this.props.options)) {
            for (var prop in this.props.options) {
