...
this.primereact_test.sidebar = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(Sidebar, [{
        ...
        if (this.mask) {
          ...
          if (this.props.blockScroll) {
            ...
            for (var i = 0; i < bodyChildren.length; i++) {
              ...
              if (core.DomHandler.hasClass(bodyChild, 'p-sidebar-mask-scrollblocker')) {
      ...
      value: function bindDocumentEscapeListener() {
        ...
        this.documentEscapeListener = function (event) {
          if (event.which === 27) {
            if (core.ZIndexUtils.get(_this2.sidebarRef.current) === core.ZIndexUtils.getCurrent('modal')) {
